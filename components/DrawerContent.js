...
<ul style={{fontSize: '15px'}}>
    <li style={{marginBottom: '25px'}}>
       <h2 style={{fontSize: '18px', textTransform: 'capitalize'}}><span className="velov-commune">{props.velov.properties.commune}</span></h2>
    </li>
    <li style={{marginBottom: '10px'}}>
        <h3
        style={(props.velov.properties.bike_stands) === 0 ? {color: "#ff7875"} : {color: "#95de64"}}>
    ...
    <li style={{marginBottom: '10px'}}>
        <h3
        style={(props.velov.properties.available_bike_stands) === 0 ? {color: "#ff7875"} : {color: "#95de64"}}>
            <FontAwesomeIcon style={{marginRight: '15px'}} icon="parking"/>
    ...
    <li style={{marginBottom: '200px'}}>
        <h3
        style={(props.velov.properties.available_bikes) === 0 ? {color: "#ff7875"} : {color: "#95de64"}}>
